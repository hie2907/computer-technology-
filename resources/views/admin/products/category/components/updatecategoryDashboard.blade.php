            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <form method="POST" action="{{route('admin.products.category.postupdatecategory',$category->categoryId)}}">
                                    @csrf
                                    <div class="col-md-6 col-lg-12">
                                        <div class="form-group">
                                            <label for="username">Tên Danh Mục</label>
                                            <input type="text" name="categoryName" class="form-control" value="{{old('categoryName',$category->categoryName)}}" />
                                        </div>
                                    </div>
