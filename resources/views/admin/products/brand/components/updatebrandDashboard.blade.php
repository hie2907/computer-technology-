        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="nav-item">
                        <a href="#">Sửa Danh Mục Thương Hiệu</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Sửa Danh Mục Thương Hiệu</div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <form method="POST"
                                    action="{{ route('admin.products.brand.postupdatebrand', $brand->brandId) }}">
                                    @csrf
                                                ...
                                                <select class="form-select input-fixed" name="categoryId" required>
                                                    @foreach ($categories as $category)
                                                        <option value="{{ $category->categoryId }}"
                                                            {{ $brand->categoryId == $category->categoryId ? 'selected' : '' }}>
