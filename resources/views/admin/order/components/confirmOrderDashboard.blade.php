        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="nav-item">
                        <a href="#">Đơn Hàng Chờ Xác Nhận</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                                        ...
                                        @foreach ($orders as $order)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="text-center">
                                                        <form
                                                            action="{{ route('admin.order.put-confi-order',$order->orderID) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <select class="form-select input-fixed mx-auto"
                                                                ...
                                                                <option value="1"
                                                                    {{ $order->order_Status == 1 ? 'selected' : '' }}>Chờ
                                                                    Xác Nhận</option>
                                                                <option value="2"
                                                                    {{ $order->order_Status == 2 ? 'selected' : '' }}>Đang
                                                                    Xử lý</option>
                                                            </select>
                                                        </form>
