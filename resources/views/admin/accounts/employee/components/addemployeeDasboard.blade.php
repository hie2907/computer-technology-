            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <form method="POST" action="{{route('admin.account.employee.postaddemployee')}}">
                                    @csrf
                                    <div class="col-md-6 col-lg-12">
                                        <div class="form-group">
                                            <label for="username">Họ Và Tên</label>
                                            <input type="text" name="adminName" class="form-control" placeholder="Nhập Họ Và Tên" />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="dateofBirth" class="form-control" id="dob" name="dob">
                                        </div>
                                        <div class="form-group">
