@extends('users.pages.auth.components.formAuthencation')
@section('formAuthen')
    <form method="POST" id="login-form" action="{{ route('client.authen-postlogin') }}">
        @csrf
        <div class="mb-3">
        ...
        <div class="d-flex align-items-center justify-content-center">
            ...
            <a class="text-primary fw-bold ms-2" href="{{ route('client.authen-register') }}">Đăng ký</a>
        </div>
    </form>
